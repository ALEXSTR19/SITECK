...
@PostMapping(path = "/tickets", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    @RequestParam(value="horaVisita", required = false) String horaVisita,
    @RequestParam(value="costoTotal", required = false) Double costoTotal,
    @RequestParam(value="anticipo", required = false) Double anticipo,
